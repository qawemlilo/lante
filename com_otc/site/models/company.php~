...
class OtcModelCompany extends JModelItem
{
    public function getCompany() {
        ...
        $query = "SELECT company.id, company.ownerid, company.name, company.share_price, company.available_shares, company.website, company.about, company.logo, owner.owner_name, owner.email, owner.cell_number ";
