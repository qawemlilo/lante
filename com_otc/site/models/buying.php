...
class OtcModelBuying extends JModelItem {
    private $_total = null;    
    ...
    public function getTable($type = 'Buy', $prefix = 'OtcTable', $config = array()) {
    ...
    private function _buildQuery() {
        $query = "SELECT transaction.ts, transaction.bidding_price, transaction.pending, transaction.expiry_date, company.name AS company, member.account_id AS account_number ";
