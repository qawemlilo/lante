...
class OtcModelCompanies extends JModelItem
{
    ...
    public function getCompany() {
        ...
        $query = "SELECT company.id, company.ownerid, company.name, company.share_price, company.available_shares, company.website, company.company_email, company.company_address, company.about, owner.owner_name, owner.email, owner.cell_number ";
        $query .= "FROM #__otc_companies AS company ";
