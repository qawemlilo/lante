...
<div class="row-fluid">
<form class="form-horizontal" name="editcompany" id="editcompany" method="post" action="index.php?option=com_otc&task=companies.editcompany">
...
<div class="control-group">
  ...
  <div class="controls">
    ...
    <a href="<?php echo JRoute::_(JURI::base() . 'index.php?option=com_otc&view=companies'); ?>" class="btn" type="button">
      Cancel
    </a>
  </div>
</div>
