...
<form style="padding-left: 45px; background-color: #F0F0F0;" id="member-registration" class="well form-validate" action="/index.php/component/users/?task=registration.register" method="post">
