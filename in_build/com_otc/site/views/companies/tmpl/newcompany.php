...
<div class="control-group">
  ...
  <div class="controls">                     
    <input id="company_email" name="company_email" placeholder="Company Email" class="input-xlarge" value="" required="" type="text">
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">                     
    <textarea id="company_address" rows="3" required="" name="company_address"></textarea>
  </div>
</div>
