...
<w:head />
<script type="text/javascript" src="<?php echo JURI::base() ?>templates/js_wright/js/script.js"></script>
<!--[if IE]>
<script type="text/javascript" src="<?php echo JURI::base() ?>templates/js_wright/js/modernizr.js"></script>
<![endif]-->
</head>
<body<?php if ($bodyclass != "") :?> class="<?php echo $bodyclass?>"<?php endif; ?>>
    ...
    <div class="<?php echo $containerClass ?>">
        ...
        <section id="main">
            ...
            <div id="featured" style="padding:0px 20px 0px 40px;">
                <w:module type="none" name="featured" chrome="xhtml" />
            </div>
        	<?php endif; ?>
        </section>
