...
?>
<div class="login<?php echo $this->pageclass_sfx?>" style="margin: 10px">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-horizontal well">
